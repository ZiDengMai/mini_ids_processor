...
// /___/   /\     Timestamp : 01/29/2024 17:42:34
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2 -w "C:/Documents and Settings/Archive/lab3_verilog/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   comp8_MUSER_dropfifo XLXI_5 (.A(waddr[7:0]), 
                                .B(raddr[7:0]), 
                                .EQ(XLXN_52));
   comp8_MUSER_dropfifo XLXI_6 (.A(raddr[7:0]), 
                                .B(XLXN_30[7:0]), 
                                .EQ(XLXN_24));
   FD XLXI_7 (.C(clk), 
              .D(fifowrite), 
   ...
   AND2B1 XLXI_14 (.I0(XLXN_21), 
                   .I1(XLXN_19), 
                   .O(XLXN_20));
   mem2 XLXI_15 (.addra(waddr[7:0]), 
                 .addrb(raddr[7:0]), 
                 .clka(clk), 
                 .clkb(clk), 
                 .dina(in_fifo0[71:0]), 
                 .wea(XLXN_23), 
                 .doutb(out_fifo[71:0]));
   AND3B2 XLXI_16 (.I0(XLXN_24), 
                   .I1(XLXN_52), 
                   .I2(fiforead), 
                   .O(XLXN_28));
   VCC XLXI_17 (.P(XLXN_43));
endmodule
